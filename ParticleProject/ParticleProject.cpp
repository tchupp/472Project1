...
CParticleProjectApp::CParticleProjectApp()
{
	...
	SetAppID(_T("ParticleProject.AppID.NoVersion"));

	// TODO: add construction code here,
	// Place all significant initialization in InitInstance
}

// The one and only CParticleProjectApp object

CParticleProjectApp theApp;


// CParticleProjectApp initialization

BOOL CParticleProjectApp::InitInstance()
{
...
int CParticleProjectApp::ExitInstance()
{
